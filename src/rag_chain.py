"""RAG chain: retrieves static context from vector DB + dynamic context from SQL, then asks LLM."""
...
def build_rag_chain(vector_store, db_path=None):
    """Return a function that takes a question and returns answer + metadata."""
    ...
    def ask(question: str) -> dict:
        ...
        # Retrieve static context from vector DB
        docs = search(vector_store, question, k=TOP_K)
        static_ctx = "\n\n".join(doc.page_content for doc in docs)

        # Retrieve dynamic context from SQL
